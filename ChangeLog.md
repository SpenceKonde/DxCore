...
* Corrected micros at 1 MHz. The ISR takes 65 clocks, we really don't need to jump through hoops to call it half as often, and micros assumed we didn't do that, but timers.h thought
* Remove several hopelessly out of date or inapplicable documentation files.
