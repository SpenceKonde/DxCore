...
* Fix all documentation links so that they always point back to the repo, so that the readme can be used to get links from even dug from a board-manager install, which doesn't have most of the docs included.
