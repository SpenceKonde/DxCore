...
`*` After an embarassingly long time of maintaining these cores, I noticed the line in the PORT description that says that the pullups are always off is the pin in output! That saves 5 clocks and 10 bytes going to output!
