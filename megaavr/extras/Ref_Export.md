...
* If the you have enabled writing to the flash from the application (for use with Flash.h), and this is not an optiboot board definition .spmALL or .spm(number) corresponding to the addresses above which the application code can write.
