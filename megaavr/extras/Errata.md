...
`*` - (*When you said "shown the way out", I presume you mean through their boss's closed window* "I hope not" *Wuss!* "Hm? I'm totally down with it, except that I don't want to pay for new windows for some executive! Customers pay for everything in the end" *Good point... See if it was me, I'd just have them executed by firing squad during a mandatory all hands meeting.* "That works for you only because you can have an all-hands meeting without any of the eyes, bodies or brains coming too" *Yeah. Never reanimage a whole corpse when you can just reanimate the useful parts* "Right. We're getting off topic, besides, the undead aren't that good at QA work"
...
I've written about this elsewhere, and will add it here later.
