...
Yes, they're both coming in the same release. We know even less about this one. For example we know that TCE is going to be built around a 16-bit timer. TCF lists 16-bits on one page, and 24 on another. And it suggests that the timer's waveform outputs are for "frequency generation" (read: duty cycle 50%; now that would represent a significant escalation of the the abuse we're taking here, and which is starting to look like the theme of the family: We already have the main feature of the famuily on the 2-series with the new ADC, but then they had to rip out the good internal oscillator and switch back to the tinyAVR one? And cut the non-tiny EB's down to sub-tiny peripheral limitations with only USART. You think we just wanted pin options? There is a HUGE difference netween 1 UART and 2 - it's a larger difference (between 1 and 2 than there is between and 5, and only a little smaller than 0 versus 1 USART). By EB release we should have gotten to look at the titles of the chapters for the next installment or two of AVRs and we'll know whether the TCE and TCF are going almost everywhere or hardly anywhere - so the size of our wager will be known and our bets placed for us; Only upon release of the EB-series will we know whether or not it was a winning gamble.  longer to see whether the Ex-series is as Exey as the double D's - or whether AVR is going to be like Windows (where alternating releases were either great or awful (by the standards of the company, to be clear. I don't think any hardware company could beat Microsoft in terms of bad releases unless they started selling parts that blew up unexpectedly - (the unexpectedly bit is key.  Otherwise, otherwise it's a different industry. A device that would burst into flames under programmable conditions could be an unsavory, but not unprofitable line of business. If it only burst into flames at random, well, that's not going to be a winner in the marketplace. Samsung tried it a few years back, and it wasn't much of a success. Though I think I'd still rather keep my phone in this asbestos lined suitcase than use Windows ME....

> Hm? Where did I get the nice suitcase? Thanks, it's it from Hazmart Short & Small Menswear, same place as the buy one get three free deal on Note 8 phones. They're my favorite apparrel, accessories and decore store. Whether you are looking for russian nerve agents, fissile material to fuel your home-built nuclear reactor or just trying to keep up with the family down the street and their "pet" tiger, they have something for everyone on your "list". Hazmart: Hazardous goods for hazardous people. See in store for details on how you can win this stylish mercury fountain (featuring genuine poisonivywood base).

> Quiz - Which one of the following actually existed: The home muclear reactor? The asbestos lined fireproof clothing? the poisonivy knicknacks? The mercury fountain? or the radium infused nuclear shampoo?
...
> *It's a trick question!* Yes, every single one of those, or something close enough for our team of expert(s) to deem them equivalent. These have all actually existed in some form or another, at one time or another - right here on earth, the works of mankind. A teenager really did make a nuclear reactor at home (people had tracked radioactive dust all over the neighborhood by the time someone realized what was going on, wooden knickknacks are in fact made through a traditional artform from trees that contain the same compounds as poison ivy (the same "active" ones, to be clear); they used it to make things like bowls and dishes and because it hardened into a durable plastic like material... though it doesn't pose the persistent toxicity of some modern plastics. And some emperor's tomb contained or had contained at one point, a pond and possibly a fountain of mercury. Asbestos cloth was widely used to make flexible fireproof objects, including clothing. And as most fans of danger already knew, around the turn of the century, radioactive material (usually radium) was just one of the many poisons sold as medicine. They put it in all kinds of things. Similarly,  Brought to you by Hazmart - something for everyone on your "list"!
