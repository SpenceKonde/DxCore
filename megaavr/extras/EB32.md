...
| 16-bit Type E pins w/WEX       | 1: 8:4:8:6      | 1: 8:4:8:6      | 1: 8:4:8:6      |
| ??-bit Type F pins             | 1: 6            | 1: 6            | 1: 6            |
...
## AVR EB32 - Well, it's got a lot of PWM capable pins
The rest if of the feature set is nothing to write home about. And we don't know how many of those PWM channels can be lit up at a time

We have no idea what TCE or WEX will be like, nor the TCF. Optimistic forcasts have this being a PWM beast - an "AT-timey". Gloomy forcasts envision ATtiny861 all over again. Losing MVIO at least gives us a pin back, which completes many mappings. It looks like the mappings of the TCE may be custom optimized to favor the low pincounts.
...
#### TCB mux options
Did they take away the second alt mapping the DU's list?
