...
```
Note also that this core default differs from the hardware default - The hardware defaults to PORTA. This reduces the number of available independent simulataneous PWM channels by 2, as you would lose the two TCBs, which can only be on PA2 and PA3.
