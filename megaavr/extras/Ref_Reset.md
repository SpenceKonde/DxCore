...
* There are many ways that execution can return to the beginning without the hardware resetting. These are a Bad Thing. This core detects this case and fires a software reset, as we are otherwise guaranteed to produce wrong behavior.
