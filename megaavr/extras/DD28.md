...
Possibly more importantly, they pick up, even at 64k, a miniscule yet dirt cheap package: VQFN-28 4x4mm 0.4mm pitch.
...
Not much of a choice was left for the core designer - the pins that the high coucil blessed at TCB capable, we only have one per timer. Note TCB2 by default is used so PC0 PWM should not be expected with millis one.
