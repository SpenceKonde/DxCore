...
Note that the core configures PORTF for PWM, mainly because PORTF isnt very useful, having few aternate functions. The hardware like everything defaults to PORTA.
