...
### PWM Pins
Though the EB is all about the baller clock system, the 14-pin specimen is hamstrung in this regerd by the inflexible layout of TCE. You're going to want a 20+ pin version if you want really see what the new timers can do.
#### TCB mux options
...
Yuck, let me rephrase that:
| Mux option   | WO0 | WO2 | WO4 | WO6 | Total number indep. TCE PWMs
|--------------|-----|-----|-----|-----|-----------------------|
|  TCE0_PORTA  | PA0 |  -  |  -  |  -  | 1
|  TCE0_PORTC  | PC0 | PC2 |  -  |  -  | 2
|  TCE0_PORTD  |  -  |  -  | PD4 | PD6 | 2
|  TCE0_PORTC2 | PA0 | PC0 | PC2 |  -  | 3

Though using the PORTD option, and two of the CCL modules to get WO0 and WO2 out o
