...
* TCA1 is by default set to PORTB, like on the DA's. Again, this decision is dubious on the DBs where the PORTMUX bug is not present, but since the port assignments are easy to change, I think aligning with the DA64 still made sense
