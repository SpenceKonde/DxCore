...
#define EVSYS_CHANNEL4_PORTB_PIN6_GC (0x46<<0)  /* Port B Pin 6 */
#define EVSYS_CHANNEL4_PORTB_PIN7_GC (0x47<<0)  /* Port B Pin 7 */
...
#define EVSYS_CHANNEL4_PORTC_PIN4_GC (0x4C<<0)  /* Port C Pin 4 */
#define EVSYS_CHANNEL4_PORTC_PIN5_GC (0x4D<<0)  /* Port C Pin 5 */
...
#define EVSYS_CHANNEL5_PORTB_PIN6_GC (0x46<<0)  /* Port B Pin 6 */
#define EVSYS_CHANNEL5_PORTB_PIN7_GC (0x47<<0)  /* Port B Pin 7 */
...
#define EVSYS_CHANNEL5_PORTC_PIN4_GC (0x4C<<0)  /* Port C Pin 4 */
#define EVSYS_CHANNEL5_PORTC_PIN5_GC (0x4D<<0)  /* Port C Pin 5 */
...
#define PORTMUX_LUT2_ALT1_GC (0x01<<2)  /* Out: PB6 In: PB0, PB1, PB2 */

/* CCL LUT3 select */
#define PORTMUX_LUT3_DEFAULT_GC (0x00<<3)  /* Out: PC4 In: PC0, PC1, PC2 */
...
#define PORTMUX_TCA04_ALT1_GC (0x01<<4)  /* WO4 on PC4 */

/* Port Multiplexer TCA0 Output 5 select */
#define PORTMUX_TCA05_DEFAULT_GC (0x00<<5)  /* WO5 on PA5 */
#define PORTMUX_TCA05_ALT1_GC (0x01<<5)  /* WO5 on PC5 */
...
#define PORTMUX_TCB1_ALT1_GC (0x01<<1)  /* WO on PC4 */
