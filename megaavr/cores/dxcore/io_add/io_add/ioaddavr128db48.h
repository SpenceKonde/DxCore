...
#define ADC_MUXPOS_VDDDIV10_GC (0x44<<0)  /* VDD/10 */
#define ADC_MUXPOS_VDDIO2DIV10_GC (0x45<<0)  /* VDDIO2/10 */
...
#define CLKCTRL_CFDSRC_CLKMAIN_GC (0x00<<2)  /* Main Clock */
#define CLKCTRL_CFDSRC_XOSCHF_GC (0x01<<2)  /* XOSCHF */
#define CLKCTRL_CFDSRC_XOSC32K_GC (0x02<<2)  /* XOSC32K */
/* clock select select */
...
#define CLKCTRL_CSUTHF_256_GC (0x00<<4)  /* 256 XOSCHF cycles */
#define CLKCTRL_CSUTHF_1K_GC (0x01<<4)  /* 1K XOSCHF cycles */
#define CLKCTRL_CSUTHF_4K_GC (0x02<<4)  /* 4K XOSCHF cycles */
...
#define CLKCTRL_FRQRANGE_8M_GC (0x00<<2)  /* Max 8 MHz XTAL Frequency */
#define CLKCTRL_FRQRANGE_16M_GC (0x01<<2)  /* Max 16 MHz XTAL Frequency */
#define CLKCTRL_FRQRANGE_24M_GC (0x02<<2)  /* Max 24 MHz XTAL Frequency */
#define CLKCTRL_FRQRANGE_32M_GC (0x03<<2)  /* Max 32 MHz XTAL Frequency */
/* Interrupt type select */
#define CLKCTRL_INTTYPE_INT_GC (0x00<<7)  /* Regular Interrupt */
#define CLKCTRL_INTTYPE_NMI_GC (0x01<<7)  /* NMI */
...
#define CLKCTRL_SELHF_XTAL_GC (0x00<<1)  /* External Crystal */
#define CLKCTRL_SELHF_EXTCLOCK_GC (0x01<<1)  /* External clock on XTALHF1 pin */
/* Source select */
#define CLKCTRL_SOURCE_OSCHF_GC (0x00<<6)  /* High frequency internal oscillator as PLL source */
#define CLKCTRL_SOURCE_XOSCHF_GC (0x01<<6)  /* High frequency external clock or external high frequency oscillator as PLL source */
...
#define EVSYS_CHANNEL0_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL0_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL0_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL0_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL1_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL1_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL1_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL1_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL2_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL2_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL2_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL2_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL3_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL3_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL3_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL3_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL4_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL4_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL4_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL4_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL5_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL5_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL5_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL5_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL6_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL6_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL6_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL6_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL7_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL7_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL7_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL7_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL8_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL8_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL8_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL8_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define EVSYS_CHANNEL9_MVIO_GC (0x05<<0)  /* MVIO VDDIO2 OK */
...
#define EVSYS_CHANNEL9_RTC_PIT_DIV512_GC (0x08<<0)  /* Periodic Interrupt Timer output 0 */
#define EVSYS_CHANNEL9_RTC_PIT_DIV256_GC (0x09<<0)  /* Periodic Interrupt Timer output 1 */
#define EVSYS_CHANNEL9_RTC_PIT_DIV128_GC (0x0A<<0)  /* Periodic Interrupt Timer output 2 */
#define EVSYS_CHANNEL9_RTC_PIT_DIV64_GC (0x0B<<0)  /* Periodic Interrupt Timer output 3 */
...
#define EVSYS_CHANNEL9_OPAMP0_READY_GC (0x34<<0)  /* OPAMP0 Ready */
#define EVSYS_CHANNEL9_OPAMP1_READY_GC (0x35<<0)  /* OPAMP1 Ready */
#define EVSYS_CHANNEL9_OPAMP2_READY_GC (0x36<<0)  /* OPAMP2 Ready */
...
#define MVSYSCFG_DUAL_GC (0x01<<3)  /* Device used in a dual supply configuration */
#define MVSYSCFG_SINGLE_GC (0x02<<3)  /* Device used in a single supply configuration */
...
/* Output Mode select */
#define OPAMP_OP0CTRLA_OUTMODE_OFF_GC (0x00<<2)  /* Output Driver Off */
#define OPAMP_OP0CTRLA_OUTMODE_NORMAL_GC (0x01<<2)  /* Output Driver in Normal Mode */
/* Negative Input Multiplexer select */
#define OPAMP_OP0INMUX_MUXNEG_INN_GC (0x00<<4)  /* Negative input pin for OPn */
#define OPAMP_OP0INMUX_MUXNEG_WIP_GC (0x01<<4)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP0INMUX_MUXNEG_OUT_GC (0x02<<4)  /* OPn output (unity gain) */
#define OPAMP_OP0INMUX_MUXNEG_DAC_GC (0x03<<4)  /* DAC output */
/* Positive Input Multiplexer select */
#define OPAMP_OP0INMUX_MUXPOS_INP_GC (0x00<<0)  /* Positive input pin for OPn */
#define OPAMP_OP0INMUX_MUXPOS_WIP_GC (0x01<<0)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP0INMUX_MUXPOS_DAC_GC (0x02<<0)  /* DAC output */
#define OPAMP_OP0INMUX_MUXPOS_GND_GC (0x03<<0)  /* Ground */
#define OPAMP_OP0INMUX_MUXPOS_VDDDIV2_GC (0x04<<0)  /* VDD/2 */
/* Multiplexer Bottom select */
#define OPAMP_OP0RESMUX_MUXBOT_OFF_GC (0x00<<2)  /* Multiplexer off */
#define OPAMP_OP0RESMUX_MUXBOT_INP_GC (0x01<<2)  /* Positive input pin for OPn */
#define OPAMP_OP0RESMUX_MUXBOT_INN_GC (0x02<<2)  /* Negative input pin for OPn */
#define OPAMP_OP0RESMUX_MUXBOT_DAC_GC (0x03<<2)  /* DAC output */
#define OPAMP_OP0RESMUX_MUXBOT_LINKOUT_GC (0x04<<2)  /* Link OP[n-1] output */
#define OPAMP_OP0RESMUX_MUXBOT_GND_GC (0x05<<2)  /* Ground */
/* Multiplexer Top select */
#define OPAMP_OP0RESMUX_MUXTOP_OFF_GC (0x00<<0)  /* Multiplexer off */
#define OPAMP_OP0RESMUX_MUXTOP_OUT_GC (0x01<<0)  /* OPn output */
#define OPAMP_OP0RESMUX_MUXTOP_VDD_GC (0x02<<0)  /* VDD */
/* Multiplexer Wiper selector select */
#define OPAMP_OP0RESMUX_MUXWIP_WIP0_GC (0x00<<5)  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP1_GC (0x01<<5)  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP2_GC (0x02<<5)  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP3_GC (0x03<<5)  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP4_GC (0x04<<5)  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP5_GC (0x05<<5)  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP6_GC (0x06<<5)  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
#define OPAMP_OP0RESMUX_MUXWIP_WIP7_GC (0x07<<5)  /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
/* Output Mode select */
#define OPAMP_OP1CTRLA_OUTMODE_OFF_GC (0x00<<2)  /* Output Driver Off */
#define OPAMP_OP1CTRLA_OUTMODE_NORMAL_GC (0x01<<2)  /* Output Driver in Normal Mode */
/* Negative Input Multiplexer select */
#define OPAMP_OP1INMUX_MUXNEG_INN_GC (0x00<<4)  /* Negative input pin for OPn */
#define OPAMP_OP1INMUX_MUXNEG_WIP_GC (0x01<<4)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP1INMUX_MUXNEG_OUT_GC (0x02<<4)  /* OPn output (unity gain) */
#define OPAMP_OP1INMUX_MUXNEG_DAC_GC (0x03<<4)  /* DAC output */
/* Positive Input Multiplexer select */
#define OPAMP_OP1INMUX_MUXPOS_INP_GC (0x00<<0)  /* Positive input pin for OPn */
#define OPAMP_OP1INMUX_MUXPOS_WIP_GC (0x01<<0)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP1INMUX_MUXPOS_DAC_GC (0x02<<0)  /* DAC output */
#define OPAMP_OP1INMUX_MUXPOS_GND_GC (0x03<<0)  /* Ground */
#define OPAMP_OP1INMUX_MUXPOS_VDDDIV2_GC (0x04<<0)  /* VDD/2 */
#define OPAMP_OP1INMUX_MUXPOS_LINKOUT_GC (0x05<<0)  /* Output from OP0 */
/* Multiplexer Bottom select */
#define OPAMP_OP1RESMUX_MUXBOT_OFF_GC (0x00<<2)  /* Multiplexer off */
#define OPAMP_OP1RESMUX_MUXBOT_INP_GC (0x01<<2)  /* Positive input pin for OPn */
#define OPAMP_OP1RESMUX_MUXBOT_INN_GC (0x02<<2)  /* Negative input pin for OPn */
#define OPAMP_OP1RESMUX_MUXBOT_DAC_GC (0x03<<2)  /* DAC output */
#define OPAMP_OP1RESMUX_MUXBOT_LINKOUT_GC (0x04<<2)  /* Link OP[n-1] output */
#define OPAMP_OP1RESMUX_MUXBOT_GND_GC (0x05<<2)  /* Ground */
/* Multiplexer Top select */
#define OPAMP_OP1RESMUX_MUXTOP_OFF_GC (0x00<<0)  /* Multiplexer off */
#define OPAMP_OP1RESMUX_MUXTOP_OUT_GC (0x01<<0)  /* OPn output */
#define OPAMP_OP1RESMUX_MUXTOP_VDD_GC (0x02<<0)  /* VDD */
/* Multiplexer Wiper selector select */
#define OPAMP_OP1RESMUX_MUXWIP_WIP0_GC (0x00<<5)  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP1_GC (0x01<<5)  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP2_GC (0x02<<5)  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP3_GC (0x03<<5)  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP4_GC (0x04<<5)  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP5_GC (0x05<<5)  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP6_GC (0x06<<5)  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
#define OPAMP_OP1RESMUX_MUXWIP_WIP7_GC (0x07<<5)  /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
/* Output Mode select */
#define OPAMP_OP2CTRLA_OUTMODE_OFF_GC (0x00<<2)  /* Output Driver Off */
#define OPAMP_OP2CTRLA_OUTMODE_NORMAL_GC (0x01<<2)  /* Output Driver in Normal Mode */
/* Negative Input Multiplexer select */
#define OPAMP_OP2INMUX_MUXNEG_INN_GC (0x00<<4)  /* Negative input pin for OPn */
#define OPAMP_OP2INMUX_MUXNEG_WIP_GC (0x01<<4)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP2INMUX_MUXNEG_OUT_GC (0x02<<4)  /* OPn output (unity gain) */
#define OPAMP_OP2INMUX_MUXNEG_DAC_GC (0x03<<4)  /* DAC output */
/* Positive Input Multiplexer select */
#define OPAMP_OP2INMUX_MUXPOS_INP_GC (0x00<<0)  /* Positive input pin for OPn */
#define OPAMP_OP2INMUX_MUXPOS_WIP_GC (0x01<<0)  /* Wiper from OPn's resistor ladder */
#define OPAMP_OP2INMUX_MUXPOS_DAC_GC (0x02<<0)  /* DAC output */
#define OPAMP_OP2INMUX_MUXPOS_GND_GC (0x03<<0)  /* Ground */
#define OPAMP_OP2INMUX_MUXPOS_VDDDIV2_GC (0x04<<0)  /* VDD/2 */
#define OPAMP_OP2INMUX_MUXPOS_LINKOUT_GC (0x05<<0)  /* Output from OP1 */
#define OPAMP_OP2INMUX_MUXPOS_LINKWIP_GC (0x06<<0)  /* Wiper from OP0's resistor ladder */
/* Multiplexer Bottom select */
#define OPAMP_OP2RESMUX_MUXBOT_OFF_GC (0x00<<2)  /* Multiplexer off */
#define OPAMP_OP2RESMUX_MUXBOT_INP_GC (0x01<<2)  /* Positive input pin for OPn */
#define OPAMP_OP2RESMUX_MUXBOT_INN_GC (0x02<<2)  /* Negative input pin for OPn */
#define OPAMP_OP2RESMUX_MUXBOT_DAC_GC (0x03<<2)  /* DAC output */
#define OPAMP_OP2RESMUX_MUXBOT_LINKOUT_GC (0x04<<2)  /* Link OP[n-1] output */
#define OPAMP_OP2RESMUX_MUXBOT_GND_GC (0x05<<2)  /* Ground */
/* Multiplexer Top select */
#define OPAMP_OP2RESMUX_MUXTOP_OFF_GC (0x00<<0)  /* Multiplexer off */
#define OPAMP_OP2RESMUX_MUXTOP_OUT_GC (0x01<<0)  /* OPn output */
#define OPAMP_OP2RESMUX_MUXTOP_VDD_GC (0x02<<0)  /* VDD */
/* Multiplexer Wiper selector select */
#define OPAMP_OP2RESMUX_MUXWIP_WIP0_GC (0x00<<5)  /* R1 = 15R, R2 = 1R, R2/R1 = 0.07 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP1_GC (0x01<<5)  /* R1 = 14R, R2 = 2R, R2/R1 = 0.14 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP2_GC (0x02<<5)  /* R1 = 12R, R2 = 4R, R2/R1 = 0.33 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP3_GC (0x03<<5)  /* R1 = 8R, R2 = 8R, R2/R1 = 1 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP4_GC (0x04<<5)  /* R1 = 6R, R2 = 10R, R2/R1 = 1.67 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP5_GC (0x05<<5)  /* R1 = 4R, R2 = 12R, R2/R1 = 3 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP6_GC (0x06<<5)  /* R1 = 2R, R2 = 14R, R2/R1 = 7 */
#define OPAMP_OP2RESMUX_MUXWIP_WIP7_GC (0x07<<5)  /* R1 = 1R, R2 = 15R, R2/R1 = 15 */
/* Input Range Select select */
#define OPAMP_PWRCTRL_IRSEL_FULL_GC (0x00<<0)  /* Full Input Range */
#define OPAMP_PWRCTRL_IRSEL_REDUCED_GC (0x01<<0)  /* Reduced Input Range */
