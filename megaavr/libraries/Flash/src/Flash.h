...
#if _AVR_FLASHMODE != 2
  #error "This library only supports parts on which the flash is erased by page and written by word or byte (ie, Dx-series). The Ex-series requires a completely different scheme, and as of the initial silicon, is severely broken"
#else
