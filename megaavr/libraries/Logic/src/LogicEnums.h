  ...
  namespace in {
    enum input_t : uint8_t {
        ...
        input_no_pullup = 0x25,
            ...
            defined(__AVR_AVR32DU28__)  || defined(__AVR_AVR16DU28__)  ||  \
            defined(__AVR_AVR32DU32__)  || defined(__AVR_AVR16DU32__)
        masked          = 0x00,
        unused          = 0x00,
        disable         = 0x00,
        feedback        = 0x01,
        ...
        input           = 0x25,
        input_no_pullup = 0x25,
      #elif defined(__AVR_AVR32SD28__)  || defined(__AVR_AVR32SD32__)  ||  \
            defined(__AVR_AVR32SD20__)  || defined(__AVR_AVR64SD32__)  ||  \
            defined(__AVR_AVR64SD48__)  || defined(__AVR_AVR64SD28__)
        masked          = 0x00,
        unused          = 0x00,
        disable         = 0x00,
        feedback        = 0x01,
