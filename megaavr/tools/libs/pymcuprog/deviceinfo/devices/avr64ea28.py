...
"""
Required device info for the avr64ea28 devices
The following data was collected from device pack Microchip.AVR-Ex_DFP 1.0.31
"""
...
DEVICE_INFO = {
    ...
    # internal_sram
    'internal_sram_address_byte': 0x6800,
