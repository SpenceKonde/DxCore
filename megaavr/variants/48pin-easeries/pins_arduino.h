...
#define digitalPinHasPWM(p)               (digitalPinHasPWMTCB(p) || ((p) >= PIN_PB0 && (p) <= PIN_PC5))
...
#define HWSERIAL1_MUX_PINSWAP_1                   (0x01 << 3 /* PORTMUX_USART1_ALT1_gc */)
...
#define HWSERIAL2_MUX_PINSWAP_1                   (0x01 /* PORTMUX_USART2_ALT1_gc */)
#define HWSERIAL2_MUX_PINSWAP_NONE                (0x03)
