...
// Timer pin swaps
#define TCA0_PINS (PORTMUX_TCA0_PORTD_gc<<PORTMUX_TCA0_gp) // TCA0 output on PD[0:5]
#define TCA1_PINS (PORTMUX_TCA1_PORTB_gc<<PORTMUX_TCA1_gp) // TCA0 output on PB[0:5]
