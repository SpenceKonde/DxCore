...
const uint8_t digital_pin_to_port[] = {
  #if CLOCK_SOURCE == 0
    // PA0 used for external clock and crystal.
    PA,  //   0 PA0
  #else
    NOT_A_PORT,
  #endif
  #if CLOCK_SOURCE != 1 && !defined(PIN_XOSCEN_PA1)
    PA,  //   1 PA1
  #else
    // PA1 used for external crystal, and possibly the enable line of external clock.
    NOT_A_PORT,
  #endif
  PA,  //   2 PA2
  PA,  //   3 PA3
