...
#define PIN_PA1 (1)
#define PIN_PC0 (2)
/* On DD14 and 20, this isn't a pin - there, everything else NOT_A_PIN's pin 12
 * but we can add 3 to it to get PIN_PC3, for example.
...
#define digitalPinHasPWM(p)               (digitalPinHasPWMTCB(p) || ((p) >= PIN_PC1 && (p) <= PIN_PC3) || (p) == PIN_PD4 || (p) == PIN_PD5)
...
#define HWSERIAL1_MUX_COUNT             2 /* default and ALT2 */
