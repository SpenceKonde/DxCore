 ...
 */
  ...
  #if defined(ARDUINO_ARCH_MEGAAVR) && (defined(MEGATINYCORE) || defined(DXCORE) || defined(ARDUINO_AVR_ATmega4808)|| defined(ARDUINO_AVR_ATmega4809)|| defined(ARDUINO_AVR_ATmega3208)|| defined(ARDUINO_AVR_ATmega3209)|| defined(ARDUINO_AVR_ATmega1608)|| defined(ARDUINO_AVR_ATmega1609)|| defined(ARDUINO_AVR_ATmega808)|| defined(ARDUINO_AVR_ATmega809))
    #include "megaavr/ServoTimers.h"
    #if (F_CPU==1000000)
      #warning "Running at 1MHz results in unstable servo signal."
    #endif
  #else
    #error "This library only supports parts used by megaTinyCore, DxCore, and MegaCoreX"
  #endif
